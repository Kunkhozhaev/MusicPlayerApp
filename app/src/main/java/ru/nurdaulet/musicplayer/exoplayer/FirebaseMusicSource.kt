...
import ru.nurdaulet.musicplayer.data.remote.MusicDatabase
import ru.nurdaulet.musicplayer.exoplayer.State.*
    ...
    fun asMediaSource(dataSourceFactory: DefaultDataSourceFactory): ConcatenatingMediaSource {
        ...
        songs.forEach { song ->
            val mediaSource = ProgressiveMediaSource.Factory(dataSourceFactory)
                // TODO : Some shit is happening here with getString fun
                .createMediaSource(
                    MediaItem.fromUri(
